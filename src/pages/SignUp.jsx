      ...
      <div style={{ width: '100%', maxWidth: 400, padding: '40px 20px' }}>
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14, marginBottom: 32 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 24, color: 'var(--heading)' }}>Create your TMS account</div>
        ...
        <div className="card-glass anim-scale-in" style={{ borderRadius: 18, padding: '26px 24px' }}>
          <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div style={{ textAlign: 'center' }}>
              <span onClick={() => navigate('/')} style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 12.5, color: 'var(--text-secondary)' }}>
