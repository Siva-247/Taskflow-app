...
export default function EditTask() {
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 22 }}>
      <div>
        <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 24, color: 'var(--heading)' }}>Edit task</div>
        ...
        <div className="responsive-grid" style={{ display: 'grid', '--cols': '1fr 1fr 1fr', gap: 22 }}>
          <Field label="Assigned to">
            <div style={{ display: 'flex', alignItems: 'center', gap: 8, padding: '11px 15px', border: '1px solid var(--border)', borderRadius: 9, background: 'var(--field-bg)' }}>
              ...
              <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 13, color: 'var(--text-secondary)' }}>{assignee?.name}</span>
            </div>
          </Field>
