      ...
      <div style={{ width: '100%', maxWidth: 400, padding: '40px 20px' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 14, marginBottom: 32 }}>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 14, color: 'var(--text-secondary)', marginTop: 6 }}>
        ...
        <div className="card-glass anim-scale-in" style={{ borderRadius: 18, padding: '26px 24px' }}>
          {mode === 'login' ? (
            <form onSubmit={handleLogin} style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              {error && <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 12.5, color: 'var(--amber-text)' }}>{error}</div>}
              <Button type="submit" variant="primary" style={{ justifyContent: 'center', marginTop: 4 }} disabled={submitting}>
                {submitting ? 'Signing in…' : 'Sign In'}
              </Button>
              <div style={{ textAlign: 'center' }}>
                <span onClick={() => { setMode('forgot'); setError(''); }} style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 12.5, color: 'var(--accent-dark)', cursor: 'pointer' }}>
                  Forgot password?
                </span>
              </div>
              <div style={{ textAlign: 'center', paddingTop: 12, borderTop: '1px solid var(--border)' }}>
                <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 12.5, color: 'var(--text-secondary)' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div style={{ textAlign: 'center' }}>
                <span onClick={backToLogin} style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 12.5, color: 'var(--accent-dark)', cursor: 'pointer' }}>
                  ← Back to sign in
                </span>
              </div>
            </div>
        ...
        <div style={{ textAlign: 'center', marginTop: 24, fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 12.5, color: 'var(--text-muted)' }}>
