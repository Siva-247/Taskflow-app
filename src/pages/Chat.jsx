        ...
        <div style={{ padding: '18px 18px 14px', borderBottom: '1px solid var(--border)' }}>
          ...
          <div style={searchFieldStyle}>
            ...
            <input
              ...
              style={{ border: 'none', outline: 'none', flex: 1, background: 'transparent', fontFamily: "'Outfit',system-ui,sans-serif", fontSize: 13, color: 'var(--text-primary)' }}
            />
          </div>
        </div>
              ...
              >
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8 }}>
                    <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: unread ? 800 : 600, fontSize: 13.5, color: 'var(--text-primary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                      {conversationLabel(c)}
                    </span>
                  ...
                  <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 8, marginTop: 3 }}>
                    ...
                    {unread && (
                      <span style={{
                        ...
                        fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 10.5, color: '#FFFFFF',
                      }}>
      ...
      <div className={`chat-thread-panel${activeConversationId ? ' has-active' : ''}`} style={panelStyle}>
        {!active ? (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: 10, ...bgPatternStyle }}>
            ...
            <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 15, color: 'var(--heading)' }}>Select a chat to start messaging</div>
            <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontSize: 12.5, color: 'var(--text-muted)' }}>Your conversations stay private to their members.</div>
          </div>
        ) : (
          <>
            <div style={{ padding: '13px 18px', borderBottom: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10 }}>
              ...
              >
                ...
                <div style={{ minWidth: 0 }}>
                  <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 14, color: 'var(--text-primary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>{conversationLabel(active)}</div>
                  <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 11.5, color: 'var(--text-muted)' }}>
                    {active.type === 'group'
            ...
            {threadSearchOpen && (
              <div style={{ padding: '10px 18px', borderBottom: '1px solid var(--border)', background: 'var(--field-bg)' }}>
                ...
                {threadSearchQuery.trim() && (
                  <div style={{ marginTop: 6, fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 11.5, color: 'var(--text-muted)' }}>
            ...
            <div onClick={closeAllPopovers} style={{ flex: 1, overflowY: 'auto', padding: '18px', display: 'flex', flexDirection: 'column', gap: 3, ...bgPatternStyle }}>
              {loadingMessages ? (
                ...
                <div style={{ margin: 'auto', textAlign: 'center', fontFamily: "'Outfit',system-ui,sans-serif", fontSize: 13, color: 'var(--text-muted)' }}>
                    ...
                    <React.Fragment key={m.id}>
                      {showDaySeparator && (
                        <div style={{ display: 'flex', justifyContent: 'center', margin: '10px 0' }}>
                          <span style={{
                            ...
                            fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 11, color: 'var(--text-muted)',
                          }}>
                      ...
                      {dividerMessageId === m.id && (
                        <div style={{ display: 'flex', alignItems: 'center', gap: 10, margin: '4px 0 10px' }}>
                          ...
                          <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 10.5, color: 'var(--amber-text)', textTransform: 'uppercase', letterSpacing: '0.04em' }}>New messages</span>
                          <div style={{ flex: 1, height: 1, background: 'var(--amber-fill)', opacity: 0.5 }} />
                        </div>
                      )}
                      <div
                      ...
                      >
                        {active.type === 'group' && !mine && (
                          <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 11, color: 'var(--accent-dark)', marginBottom: 2, marginLeft: 4 }}>{sender?.name}</span>
                        )}
                        <div
                          style={{
                        ...
                        >
                          ...
                          >
                            {isDeleted && (
                              <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontStyle: 'italic', fontSize: 13, opacity: 0.75 }}>
                              ...
                              <div style={{ display: 'flex', alignItems: 'flex-end', gap: 6, minWidth: 180 }} onClick={(e) => e.stopPropagation()}>
                                <textarea
                                  ...
                                  style={{
                                    ...
                                    borderRadius: 7, padding: '5px 8px', fontFamily: "'Outfit',system-ui,sans-serif",
                            ...
                            {!isDeleted && !isEditing && (
                              <>
                                {repliedMsg && (
                                  ...
                                  >
                                    <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 11, color: mine ? 'rgba(255,255,255,0.85)' : 'var(--accent-dark)' }}>
                                      {repliedMsg.senderId === currentUser.id ? 'You' : directoryUsers.find((u) => u.id === repliedMsg.senderId)?.name || 'Someone'}
                                    </span>
                                    <span style={{
                                      fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 12, opacity: 0.85,
                                ...
                                {m.text && (
                                  <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 13.5, lineHeight: 1.45, whiteSpace: 'pre-wrap', wordBreak: 'break-word', marginTop: m.imageUrl ? 6 : 0, padding: m.imageUrl ? '0 6px' : 0 }}>
                          ...
                          <div style={{ display: 'flex', gap: 4, marginTop: 4, flexWrap: 'wrap', justifyContent: mine ? 'flex-end' : 'flex-start' }}>
                            {m.reactions.map((r) => {
                              ...
                              return (
                                ...
                                >
                                  <span>{r.emoji}</span>
                                  <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 10.5, color: reactedByMe ? 'var(--accent-dark)' : 'var(--text-muted)' }}>{r.userIds.length}</span>
                                </span>
                              );
                            })}
                          </div>
                        ...
                        <div style={{ display: 'flex', alignItems: 'center', gap: 4, marginTop: 3 }}>
                          <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 10.5, color: 'var(--text-muted)' }}>{formatMessageTime(m.createdAt)}</span>
              ...
              {typingUserIds.length > 0 && (
                <div style={{ display: 'flex', alignItems: 'center', gap: 7, marginTop: 4 }}>
                  ...
                  <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 11.5, color: 'var(--text-muted)' }}>
            ...
            {replyingTo && (
              <div style={{ padding: '9px 18px', borderTop: '1px solid var(--border)', display: 'flex', alignItems: 'center', gap: 10, background: 'var(--field-bg)' }}>
                ...
                <div style={{ flex: 1, minWidth: 0 }}>
                  <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 11.5, color: 'var(--accent-dark)' }}>
                    Replying to {replyingTo.senderId === currentUser.id ? 'yourself' : directoryUsers.find((u) => u.id === replyingTo.senderId)?.name || 'someone'}
                  </div>
                  <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 12, color: 'var(--text-secondary)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
                ...
                <div style={{ ...popoverStyle, left: 18, right: 18, bottom: '100%', marginBottom: 6 }}>
                  {mentionCandidates.map((m) => (
                    ...
                    >
                      ...
                      <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 12.5, color: 'var(--text-primary)' }}>{m.name}</span>
                    </div>
                  ))}
                </div>
              )}
              ...
              {recording ? (
                <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 10 }}>
                  ...
                  <div style={{ flex: 1, display: 'flex', alignItems: 'center', gap: 8 }}>
                    ...
                    <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 13, color: 'var(--text-primary)' }}>
...
const emptyStateStyle = {
  padding: '36px 20px', textAlign: 'center', fontFamily: "'Outfit',system-ui,sans-serif", fontSize: 13, color: 'var(--text-muted)', lineHeight: 1.6,
};
...
const composerTextareaStyle = {
  ...
  fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 13.5, color: 'var(--text-primary)',
          ...
          <div style={{ maxHeight: 220, overflowY: 'auto', border: '1px solid var(--border)', borderRadius: 9 }}>
            ...
            {candidates.map((u) => (
              <label key={u.id} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '9px 12px', cursor: 'pointer', borderBottom: '1px solid var(--border)' }}>
                ...
                <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 13, color: 'var(--text-primary)' }}>{u.name}</span>
                <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 11.5, color: 'var(--text-muted)' }}>{u.title}</span>
              </label>
            ))}
          </div>
        </Field>
        ...
        <div style={{ maxHeight: 280, overflowY: 'auto', border: '1px solid var(--border)', borderRadius: 9 }}>
          {candidates.map((u) => (
            <div key={u.id} onClick={() => handlePick(u.id)} style={{ display: 'flex', alignItems: 'center', gap: 10, padding: '10px 12px', cursor: 'pointer', borderBottom: '1px solid var(--border)' }}>
              ...
              <div>
                <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 13, color: 'var(--text-primary)' }}>{u.name}</div>
                <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 11.5, color: 'var(--text-muted)' }}>{u.title}</div>
              </div>
            </div>
          ))}
          {candidates.length === 0 && (
      ...
      <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          ...
          {conversation.members.map((m) => (
            <div key={m.id} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 10, padding: '8px 0', borderBottom: '1px solid var(--border)' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                ...
                <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 13, color: 'var(--text-primary)' }}>{m.name}{m.id === currentUser.id ? ' (you)' : ''}</span>
              </div>
              {canManage && m.id !== currentUser.id && (
                <span onClick={() => onRemoveMember(m.id)} style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 11.5, color: 'var(--amber-text)', cursor: 'pointer' }}>Remove</span>
              )}
            </div>
          ))}
        </div>
        {canManage && (
          adding ? (
            ...
            <span onClick={() => setAdding(true)} style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 12.5, color: 'var(--accent-dark)', cursor: 'pointer' }}>+ Add member</span>
          )
        )}
      </div>
