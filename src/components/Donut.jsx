    ...
    <div style={{ display: 'flex', alignItems: 'center', gap: 26, marginTop: 18 }}>
      <div style={{ position: 'relative', width: 118, height: 118, flexShrink: 0 }}>
        ...
        <div style={{ position: 'absolute', inset: 0, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 16, color: 'var(--heading)' }}>{total}</div>
          <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 10, color: 'var(--text-muted)', marginTop: 1 }}>total</div>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: 11 }}>
        {[
          ...
          <div key={row.label} style={{ display: 'flex', alignItems: 'center', gap: 9 }}>
            ...
            <span style={{ flex: 1, fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 500, fontSize: 13, color: 'var(--text-primary)' }}>{row.label}</span>
            <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 13, color: 'var(--heading)' }}>
