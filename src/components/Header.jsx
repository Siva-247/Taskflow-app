...
import { IconLogo, IconBell, IconMenu, IconSun, IconMoon } from './icons.jsx';
  ...
  return (
    <div style={{
      ...
      <div style={{ display: 'flex', alignItems: 'center', gap: 18, flexShrink: 0 }}>
        ...
        <div className="header-icon-btn" style={{ display: 'flex', alignItems: 'center', gap: 9, cursor: 'pointer', padding: '4px 8px', borderRadius: 999, marginRight: -8 }} onClick={() => setProfileOpen((v) => !v)}>
