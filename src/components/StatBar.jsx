        ...
        >
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
              <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 22, color: 'var(--heading)', lineHeight: 1 }}>{item.value}</span>
              {item.badge && <span style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 700, fontSize: 11.5, color: 'var(--accent-dark)' }}>{item.badge}</span>}
            </div>
            <div style={{ fontFamily: "'Outfit',system-ui,sans-serif", fontWeight: 600, fontSize: 12, color: 'var(--text-secondary)', marginTop: 3 }}>{item.label}</div>
          </div>
        </div>
      ))}
    </div>
